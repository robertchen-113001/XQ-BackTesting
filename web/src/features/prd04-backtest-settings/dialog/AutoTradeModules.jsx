...
const s = {
  ...
  th: { fontSize: 12, fontWeight: 600, color: 'var(--color-text-secondary)', padding: '6px 10px', background: '#f5f5f5', borderBottom: '1px solid var(--color-border)', textAlign: 'left' },
  td: { fontSize: 13, color: 'var(--color-text)', padding: '5px 10px', borderBottom: '1px solid var(--color-border)' },
  paramInput: { width: 90, fontSize: 12, padding: '2px 4px', border: '1px solid var(--color-border)', borderRadius: 3, background: 'var(--color-surface)' },
  ...
  offsetLabel: { fontSize: 12, color: 'var(--color-text-secondary)' },
