              ...
              return (
                <label
                  ...
                  style={{
                    ...
                    border: disabled ? '1px solid #eee' : '1px solid transparent',
                  }}
                >
                  <input
                    type="radio"
                    name="returnAlgorithm-dialog"
                    value={algo}
                    checked={form.returnAlgorithm === algo}
                    disabled={disabled}
                    onChange={() => !disabled && onChange('returnAlgorithm', algo)}
                    style={{ marginRight: 4 }}
                  />
                  {algo}
                </label>
...
const s = {
  ...
  radioLabel: { fontSize: 13, cursor: 'pointer', display: 'flex', alignItems: 'center', color: 'var(--color-text)', userSelect: 'none' },
